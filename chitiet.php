	...
	<section>
		<div class="w3-container w3-center">
			...
			<div id="chitiet-baidang">
				...
				<?php if($ctbd['soluong']==0){ ?>
					<label class="themvaogio w3-button w3-round w3-cyan w3-left w3-margin-left w3-mobile w3-disabled"><a href="?action=datmua&id=<?php echo $ctbd['id'] ?>">Đặt mua</a></label>
				<?php }else{?>
					<label class="themvaogio w3-button w3-round w3-cyan w3-left w3-margin-left w3-mobile"><a href="?action=datmua&id=<?php echo $ctbd['id'] ?>"">Đặt mua</a></label>
				<?php } ?>
				<label class="themvaogio w3-button w3-round w3-amber w3-left w3-margin-left w3-mobile"><a href="?action=themvaogio&id=<?php echo $ctbd['id'] ?>"">Thêm vào giỏ</a></label><br/><br/>
				<?php if(!empty($anhbd)){ ?>
