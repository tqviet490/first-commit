	...
	<section>
		<div class="w3-container w3-center">
			...
			<div id="chitiet-baidang">
				...
				<br/>
				<label class="themvaogio w3-button w3-round w3-cyan w3-left w3-margin-left w3-mobile"><a href="?action=duyet&id=<?php echo $ctbd['id'] ?>" onclick="return confirm('Bạn có chắc muốn duyệt bài đăng này không?')">Duyệt bài đăng</a></label>
